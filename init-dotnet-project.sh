...
rm -f .claude/personas .claude/agents .claude/recipes
rm -f .claude/commands/dotnet .claude/commands/productivity .claude/commands/engineering
rm -f .agents/personas .agents/agents .agents/recipes
rm -f .agents/skills/dotnet .agents/skills/productivity .agents/skills/engineering

ln -s "$DOTNET_SKILLS_DIR/skills"        ".claude/commands/dotnet"
ln -s "$STACK_DIR/skills/productivity"   ".claude/commands/productivity"
ln -s "$STACK_DIR/skills/engineering"    ".claude/commands/engineering"
ln -s "$STACK_DIR/agents"                ".claude/agents"
ln -s "$DOTNET_SKILLS_DIR/recipes"       ".claude/recipes"
echo "✅ Setup .NET symlinks in .claude"
